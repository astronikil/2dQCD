...
c      
      ...
      integer, parameter :: ntotr=ncr*ncr**mb
      ...
      complex*16, parameter :: glzi = (0.0D0,1.0D0)
      complex*16, parameter :: zph=exp(glzi*acos(-1.0D0)/mx)
      complex*16, parameter :: zphconj=conjg(zph)
